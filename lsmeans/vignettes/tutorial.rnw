...
We will fit a model using the "lmer" function in the \pkg{lme4} package. This will be a mixed model with random intercepts for "Block" and "Block:Variety" (which identifies the plots).
<<>>=
