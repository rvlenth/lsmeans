...
@
The LS~means shown are the geometric means of the predictions, as opposed to the arithmetic means obtained from "rg.bc.regrid". And the pairwise comparisons come out as ratios of these.
